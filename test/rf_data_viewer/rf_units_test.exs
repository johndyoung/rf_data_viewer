defmodule RFDataViewer.RFUnitsTest do
  ...
  describe "rf_units" do
    ...
    test "create_rf_unit/1 with valid data creates a rf_unit" do
      valid_attrs = %{name: "some name", description: "some description", manufacturer: "some manufacturer"}
    ...
    test "update_rf_unit/2 with valid data updates the rf_unit" do
      rf_unit = rf_unit_fixture()
      update_attrs = %{name: "some updated name", description: "some updated description", manufacturer: "some updated manufacturer"}
  ...
  describe "rf_unit_serial_numbers" do
    ...
    test "update_rf_unit_serial_number/2 with valid data updates the rf_unit_serial_number" do
      ...
      assert {:ok, %RFUnitSerialNumber{} = rf_unit_serial_number} = RFUnits.update_rf_unit_serial_number(rf_unit_serial_number, update_attrs)
    ...
    test "update_rf_unit_serial_number/2 with invalid data returns error changeset" do
      rf_unit_serial_number = rf_unit_serial_number_fixture()
      assert {:error, %Ecto.Changeset{}} = RFUnits.update_rf_unit_serial_number(rf_unit_serial_number, @invalid_attrs)
    ...
    test "delete_rf_unit_serial_number/1 deletes the rf_unit_serial_number" do
      rf_unit_serial_number = rf_unit_serial_number_fixture()
      assert {:ok, %RFUnitSerialNumber{}} = RFUnits.delete_rf_unit_serial_number(rf_unit_serial_number)
      assert_raise Ecto.NoResultsError, fn -> RFUnits.get_rf_unit_serial_number!(rf_unit_serial_number.id) end
    end
