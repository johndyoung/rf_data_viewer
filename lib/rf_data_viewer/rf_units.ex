defmodule RFDataViewer.RFUnits do
  ...
  @doc """
  Returns a list of all RF units in a tuple of the form {rf_unit, sn_count, test_set_count, data_set_count, data_count}
  ...
  @doc """
  Returns a list of all serial numbers associated with a given RF Unit in a tuple of the form {sn, test_set_count, data_set_count, data_count}

  ## Examples

      iex> get_rf_unit_serial_numbers_with_counts(1)
      [{%RFUnitSerialNumber{}, 0, 0, 0}, ...]
  """
